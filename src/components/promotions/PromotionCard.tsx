...
export const PromotionCard = ({
  ...
  return (
    <motion.div 
      ...
      className="group relative overflow-hidden rounded-2xl bg-white border flex flex-col h-full"
    >
      ...
      <div className="px-5 pt-5 pb-6 flex flex-col flex-1">
        ...
        <div className="flex gap-4 mb-4">
          <div className="flex flex-col items-start justify-center">
            ...
            <div className="text-sm line-through text-red-600 font-semibold">
              {formatEuro(retailPrice)}
            </div>
          </div>
          <div className="flex flex-col items-start justify-center">
            <div className="text-xs text-gray-500 mb-1 font-medium">Price to Traveller</div>
            <div className="text-base text-[#005488] font-semibold">
              {formatEuro(travellerPrice)}
            </div>
          </div>
        </div>
